...
void defaultMain();
void performanceEvaluationMain();

/* MAIN PROGRAM */
int main(int argc, const char *argv[])
{
    #if(PERFORMANCE_EVAL_CTRL == STD_ON)
    performanceEvaluationMain();
    #else
    defaultMain();
    #endif
...
void defaultMain()
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        if(bVis)
        {
            bool waitUntilUserPressZero = true;
            show3DObjects((dataBuffer.end()-1)->boundingBoxes, cv::Size(4.0, 20.0), cv::Size(1000, 1000), waitUntilUserPressZero);
        }
        bVis = false;
...
void performanceEvaluationMain()
{
    ...
    #endif
    cout<<"Detector, Descriptor, Matcher, Matcher Descriptor, Img, Nr. Keypoints, Nr. Matched keypoints,TTC Lidar, TTC Camera\n";
